...
adt-and-scoping
Explores the design of parameterized abstract data types and variable scoping mechanisms in programming languages. Implemented using a C++ template Vector class, this project examines how languages support generic ADTs, contrasts static vs. dynamic scoping, and demonstrates the behavior of shallow and deep copies in memory management.git 